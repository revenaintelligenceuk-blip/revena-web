...
export const Footer = () => {
  ...
  return (
    <footer className="py-32 px-6 md:px-12 lg:px-24 bg-navy text-cream relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto pt-24 mt-24 border-t border-cream/5 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 relative z-10">
        ...
        <div className="flex items-center space-x-8 text-[9px] font-sans font-bold uppercase tracking-[0.5em] text-cream/20">
          ...
          <div className="w-1 h-1 bg-cream/10 rounded-full" />
